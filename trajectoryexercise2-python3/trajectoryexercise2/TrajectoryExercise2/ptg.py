...
def PTG(start_s, start_d, target_vehicle, delta, T, predictions):
    ...
    while t <= T + 4 * timestep:
        ...
        #print("t",t,"goals size",len(goals)) #--> total t=9, 11
        
        all_goals += goals
        t += timestep
    #print("size of all_goals",len(all_goals)) #--> 99
